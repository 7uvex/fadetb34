...
do
    ...
    box.FocusLost:Connect(function(enter) if enter then accept() end end)
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("fade.cc| Security : You are running another script, please disable it and execute again")
    end
end
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "South Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(57, 255, 20)">fade.</font>cc\n' .. Title
                    ...
                    task.spawn(function()
                        ...
                        while tick() < endTime do
                            ...
                            textLabel.Text = string.format(
                                '<font color="rgb(57, 255, 20)">fade.cc</font>lol\n%s\nplease wait : <font color="rgb(57, 255, 20)">%.2f</font> seconds',
                ...
                if Timing then
                    task.spawn(function()
                        ...
                        while tick() < endTime do
                            ...
                            textLabel.Text = string.format(
                                '<font color="rgb(57, 255, 20)">fade.cc</font>cc\n%s\nplease wait : <font color="rgb(57, 255, 20)">%.2f</font> seconds',
                                Title, math.max(timeLeft, 0)
                            )
...
local window = library:window({name = "fade", suffix = ".cc", gameInfo = string.format("fade.cc : %s", Game_Name:lower())})
